    ...
    <main className="mx-auto max-w-5xl space-y-8 px-6 py-14">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          ClearAudit exists for founders and CTOs who suddenly realize that their next big customer is not blocked by product value, but by a security questionnaire they are not ready to answer.
        </p>
      </div>
      <div className="space-y-5 text-muted-foreground">
        ...
        <p>
          ClearAudit focuses on the operational controls that commonly stall B2B SaaS deals: privileged access, MFA coverage, branch protections, review discipline, ownership, and policy maturity.
        </p>
        <p>
